...
<body>
    <header>
        ...
        <!-- Banner -->
        <section class="">
            <img src="{{ asset('images/shop-banner.jpg') }}" alt="" class="w-full">
        </section>
        <!-- End Banner -->
    </header>
    <main>
                ...
                <div class="grid grid-cols-3 gap-8">
                    ...
                    <div>
                      <div class="overflow-hidden ">
                        <img src="{{ $book->thumbnail }}" class="hover:scale-125 duration-1000" alt="">
                      </div>
                      <div class="bg-[#F5F5F5] p-4">
                        <a href="" class="hover:text-[#CA8A04]">
                          <h3 class="font-semibold text-xl">{{ $book->title }}</h3>
                        </a>
                        <p class="text-[#898989] text-base mt-1 mb-2">{{ $book->title }}</p>
                        <p class="font-semibold text-xl text-[#EF4444] mb-3">{{ $book->Price }} VND </p>
